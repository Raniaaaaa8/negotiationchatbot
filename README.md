...
## 3. Demo
install requierements from requierements.txt
(a) run with dockerfile:

docker build -t chatbot .
docker run -p 5000:5000 -ti chatbot 

Run on browser http://127.0.0.1:5000/
(b) run locally
python3 main_Blender_90M.py
## 4. Details
...
- main_Blender_90M.py (this one is the best performing and trained on the negotiation task using the dataset provided by Meta)
